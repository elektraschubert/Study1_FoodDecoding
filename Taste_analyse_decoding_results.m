...
study_name = 'TasteDecoding_1010';

% Base directory path
bdir = '/Users/elektraschubert/Documents/PhD/Study 1/MVPA Analyses/';

% Output directory (where decoding results have been saved)
output_dir = '/Users/elektraschubert/Documents/PhD/Study 1/MVPA Analyses/Decoding Results/Taste/1010/';
...
channel_names_file = 'channelinfo.mat'; % Name of .mat file containing channel labels and channel locations
...
% data arrays.
cond_labels{1} = 'Image Presentation (Taste)';
...
multcompstats = 4; % Correction for multiple comparisons: 
                    % 0 = no correction
